...
def welcome(request):
    if not request.user.is_authenticated:
        ...
        return render(request, 'users/index.html', {'user':request.user, 'source':'welcome'})

def homepage(request, source=None):
    if not request.user.is_authenticated:
        return render(request, 'users/homepage.html', {})
    else:
        return render(request, 'users/index.html', {'user':request.user, 'source':source})
